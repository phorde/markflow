...
<template>
@C:/ExtratorLaudos/.codex/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/ExtratorLaudos/.codex/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/ExtratorLaudos/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/ExtratorLaudos/.codex/get-shit-done/workflows/diagnose-issues.md
