...
<reference>
@C:/ExtratorLaudos/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/ExtratorLaudos/.codex/get-shit-done/references/user-profiling.md` to load:
