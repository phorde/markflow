...
<execution_context>
@C:/ExtratorLaudos/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/ExtratorLaudos/.codex/get-shit-done/workflows/add-todo.md`.
