...
Key references:
- @C:/ExtratorLaudos/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @C:/ExtratorLaudos/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/ExtratorLaudos/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md" "C:/ExtratorLaudos/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/ExtratorLaudos/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @C:/ExtratorLaudos/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/ExtratorLaudos/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at C:/ExtratorLaudos/.codex/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/ExtratorLaudos/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="C:/ExtratorLaudos/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    C:/ExtratorLaudos/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   C:/ExtratorLaudos/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        C:/ExtratorLaudos/.codex/AGENTS.md
```
