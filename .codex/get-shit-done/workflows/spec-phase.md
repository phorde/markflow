...
```bash
INIT=$(node "C:/ExtratorLaudos/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/ExtratorLaudos/.codex/get-shit-done/templates/spec.md.
