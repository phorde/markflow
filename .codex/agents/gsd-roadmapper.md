...
Reference full template: `C:/ExtratorLaudos/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/ExtratorLaudos/.codex/get-shit-done/templates/state.md`.
