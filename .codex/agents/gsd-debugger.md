...
<required_reading>
@C:/ExtratorLaudos/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/ExtratorLaudos/.codex/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/ExtratorLaudos/.codex
                  → checks C:/ExtratorLaudos/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/ExtratorLaudos/.codex/get-shit-done
                  → writes to C:/ExtratorLaudos/.codex/get-shit-done/hooks/
...
@C:/ExtratorLaudos/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/ExtratorLaudos/.codex/get-shit-done/references/common-bug-patterns.md
