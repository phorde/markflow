...
Reference full template: `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/state.md`.
