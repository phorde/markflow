...
```
Task(
  prompt="Read C:/ExtratorLaudos/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/ExtratorLaudos/.codex/get-shit-done/templates/SECURITY.md`
