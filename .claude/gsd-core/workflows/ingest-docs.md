...
```bash
INIT=$(node "/home/ubuntu/dev/markflow/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/ubuntu/dev/markflow/.claude/gsd-core/bin/gsd-tools.cjs" commit \
