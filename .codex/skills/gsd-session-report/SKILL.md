...
<execution_context>
@C:/ExtratorLaudos/.codex/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/ExtratorLaudos/.codex/get-shit-done/workflows/session-report.md end-to-end.
</process>
