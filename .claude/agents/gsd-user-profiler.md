...
<reference>
@/home/ubuntu/dev/markflow/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ubuntu/dev/markflow/.claude/gsd-core/references/user-profiling.md` to load:
