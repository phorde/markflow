...
Use template from `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/UI-SPEC.md`
