...
@/home/ubuntu/dev/markflow/.claude/gsd-core/references/git-integration.md
</required_reading>
...
See `/home/ubuntu/dev/markflow/.claude/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/ubuntu/dev/markflow/.claude/gsd-core/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/summary.md`.
