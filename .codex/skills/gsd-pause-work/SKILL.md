...
<execution_context>
@C:/ExtratorLaudos/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
<process>
**Follow the pause-work workflow** from `@C:/ExtratorLaudos/.codex/get-shit-done/workflows/pause-work.md`.
