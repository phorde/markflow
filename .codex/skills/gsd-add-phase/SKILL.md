...
<execution_context>
@C:/ExtratorLaudos/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/ExtratorLaudos/.codex/get-shit-done/workflows/add-phase.md`.
