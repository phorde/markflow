...
<!-- For checkpoint task examples and patterns, see @/home/ubuntu/dev/markflow/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/ubuntu/dev/markflow/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/ubuntu/dev/markflow/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
