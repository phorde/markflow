...
```markdown
Read /home/ubuntu/dev/markflow/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/ubuntu/dev/markflow/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/ubuntu/dev/markflow/.claude/agents/gsd-ui-checker.md for instructions.
