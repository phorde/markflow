...
```
Agent(
  prompt="Read /home/ubuntu/dev/markflow/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/dev/markflow/.claude/gsd-core/templates/VALIDATION.md`
