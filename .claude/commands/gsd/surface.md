...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/ubuntu/dev/markflow/.claude/.gsd-surface.json`
(sibling to `/home/ubuntu/dev/markflow/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/ubuntu/dev/markflow/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/ubuntu/dev/markflow/.claude/skills`).
...
`/home/ubuntu/dev/markflow/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/ubuntu/dev/markflow/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/ubuntu/dev/markflow/.claude/.gsd-surface.json`
Install profile marker: `/home/ubuntu/dev/markflow/.claude/.gsd-profile`
Skill dirs: `/home/ubuntu/dev/markflow/.claude/skills/gsd-*/`
Engine module: `/home/ubuntu/dev/markflow/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/ubuntu/dev/markflow/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
