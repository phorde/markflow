...
INSTALL_JS_GLOBAL="/home/ubuntu/dev/markflow/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/ubuntu/dev/markflow/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
