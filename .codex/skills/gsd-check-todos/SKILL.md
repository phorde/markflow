...
<execution_context>
@C:/ExtratorLaudos/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/ExtratorLaudos/.codex/get-shit-done/workflows/check-todos.md`.
