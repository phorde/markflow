...
```markdown
Read C:/ExtratorLaudos/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/ExtratorLaudos/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/ExtratorLaudos/.codex/agents/gsd-ui-checker.md for instructions.
